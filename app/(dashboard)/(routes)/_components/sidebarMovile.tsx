...
import { CreatePostButton } from "../../_components/ButtonTweet";
...
const SidebarMovile = () => {
  ...
  return (
    <div className="h-screen flex flex-col space-y-8 items-end py-2 w-min">
      <div className="flex flex-col items-end mt-8">
        <div className="p-2 my-2 rounded-full dark:bg-sky-300 w-min mb-8">
        ...
        {SibedarIcons.map(({ name, icon: Icon, path }) => {
          ...
          return (
            <Link
              ...
              href={path}
              className={cn(
                "flex flex-row-reverse items-center gap-2 p-2 rounded-xl w-min hover:bg-gray-200 dark:hover:bg-gray-600 transition ease-in-out duration-300 mb-2",
